                    ...
                    <article>
                        ...
                        <section className="banner mask-overlay pad-120 white-clr">
                            <div className="container theme-container rel-div">
                                <img className="pt-10 effect animated fadeInLeft" height= '35px' alt="" src="assets/img/icons/icon-1.png" />
                                <ul className="list-items fw-600 effect animated wow fadeInUp" data-wow-offset={50} data-wow-delay=".20s">
                                    <li><a href="#">Customer First</a></li>
                                    <li><a href="#">People-Led</a></li>
                                    <li><a href="#">Innovation-Driven</a></li>
                                </ul>
                                <h2 className="section-title fs-48 effect animated wow fadeInUp" 
                                data-wow-offset={50} data-wow-delay=".20s"> Bongo Express <br /> <span className="theme-clr"> courier </span> &amp; <span className="theme-clr"> delivery </span> services </h2>
                            </div>
                        ...
                        <section className="pad-80 about-wrap clrbg-before">
                            <span className="bg-text wow fadeInUp" data-wow-offset={50} data-wow-delay=".20s"> About </span>
                            <div className="theme-container container">
                                <div className="row">
                                    <div className="col-md-6">
                                        <div className="about-us">
                                            <h2 className="section-title pb-10 wow fadeInUp" data-wow-offset={50} data-wow-delay=".20s"> About Us </h2>
                                    ...
                                    <div className="col-md-6 text-center">
                                        ...
                                        <img alt="" src="assets/img/block/about-img.png" className="wow slideInRight" data-wow-offset={50} data-wow-delay=".20s" />
                                    </div>
                                </div>
                            </div>
                        </section>
                                ...
                                <div className="row">
                                    <div className="col-md-11 col-md-offset-1">
                                        <div className="pt-120 rel-div">
                                            ...
                                            <h2 className="section-title wow fadeInUp" data-wow-offset={50} data-wow-delay=".20s"> Get the <span className="theme-clr"> fastest </span>delivery </h2>
                                            <p className="fs-16 wow fadeInUp" data-wow-offset={50} data-wow-delay=".25s">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam <br />
                                        ...
                                        <div className="delivery-img pt-10">
                                            <img alt="" src="assets/img/block/delivery.png" className="wow slideInLeft" data-wow-offset={50} data-wow-delay=".20s" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <section className="contact-wrap pad-120">
                            <span className="bg-text wow fadeInLeft" data-wow-offset={50} data-wow-delay=".20s"> Contact </span>
                            <div className="theme-container container">
                                <div className="row">
                                    <div className="col-md-6 col-sm-8">
                                        <div className="title-wrap">
                                            <h2 className="section-title wow fadeInLeft" data-wow-offset={50} data-wow-delay=".20s">contact us</h2>
